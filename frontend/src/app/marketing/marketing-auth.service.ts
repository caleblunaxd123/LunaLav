...
@Injectable({ providedIn: 'root' }) export class MarketingAuthService {
  ...
  changePassword(actualPassword: string, nuevaPassword: string) { return this.http.post(`${environment.apiUrl}/marketing/auth/change-password`, { actualPassword, nuevaPassword }); }
