...
export class MarketingModulesComponent implements OnInit, OnDestroy {
  ...
  pub:any={tipo:'promo',temporada:'ninguna',negocio:'LunaLav',oferta:'',zona:'',contacto:'',emojis:true};postText='';copiado=signal(false);historial=signal<any[]>([]);private histKey='lunalav.pub.historial';
